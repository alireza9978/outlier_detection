...
# load data
data_dir = [('/home/alireza/projects/python/outlier/outlier_detection/datasets/instagram', "instagram")]
...
def load_model_make_csv_50v2(train_data_gen, name):
    ...
    np.savetxt(output_dir + name + '_ResNet50V2.csv', all_array, delimiter=",")
...
def load_model_make_csv_101v2(train_data_gen, name):
    ...
    print(all_array.shape)
    np.savetxt(output_dir + name + '_ResNet101V2.csv', all_array, delimiter=",")
...
def load_model_make_csv_152v2(train_data_gen, name):
    ...
    print(all_array.shape)
    np.savetxt(output_dir + name + '_ResNet152V2.csv', all_array, delimiter=",")
...
def load_model_make_csv_121(train_data_gen, name):
    ...
    print(all_array.shape)
    np.savetxt(output_dir + name + '_DenseNet121.csv', all_array, delimiter=",")
...
def load_model_make_csv_169(train_data_gen, name):
    ...
    print(all_array.shape)
    np.savetxt(output_dir + name + '_DenseNet169.csv', all_array, delimiter=",")
...
def load_model_make_csv_201(train_data_gen, name):
    ...
    print(all_array.shape)
    np.savetxt(output_dir + name + '_DenseNet201.csv', all_array, delimiter=",")
